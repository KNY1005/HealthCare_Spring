...
<title>자가진단</title>
    ...
    <script>
      ...
      var num_of_test = 14; // 문제의 총 개수를 저장하는 변수
      ...
      var test_text = [
        ...
        ["7. 식은땀과 극심한 오한의 동반되는 증상이 있다."],
        ["8. 속이 메스껍고 구토, 설사를 한다."],
        ["9. 10일이 지나도 증상이 좋아지지 않거나 오히려 악화된다."],
        ["10. 귀의 통증이 있다."],
        ["11. 심한 두통이 있다."],
        ["12. 종종 호흡까지 곤란하다."],
        ["13. 목이 따끔거리거나 아프다. "],
        ["14.묽고 투명한 분비물(체액)의 콧물이 비친다."],
    ...
    <main>
      <div class="main_box">
        ...
        <div class="btn_box">
          ...
          <button class="end_btn" onclick="location.href='<%=request.getContextPath() %>/'">메인화면으로</button>
        </div>
      </body>
      </div>
    </main>
